...
# 19 "ECU_Layer/../MCAL_Layer/GPIO/../std_types.h"
...
.button_pin.pin=PIN0,
.button_pin.directin=INPUT,
.button_pin.logic=LOW,
.button_connection=BUTTON_RELEASED,
...
gpio_port_write_logic(PORTC_INDEX,direction);
_delay((unsigned long)((3000)*(4000000UL/4000.0)));
gpio_port_toggle_logic(PORTC_INDEX);
_delay((unsigned long)((3000)*(4000000UL/4000.0)));
uint8 logic;
gpio_port_read_logic(PORTC_INDEX,&logic);
gpio_port_write_logic(PORTC_INDEX,logic);
_delay((unsigned long)((3000)*(4000000UL/4000.0)));
}
return (0);
}
