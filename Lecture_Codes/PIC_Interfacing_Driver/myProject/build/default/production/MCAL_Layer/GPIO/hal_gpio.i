...
# 52 "C:/Program Files (x86)/Microchip/MPLABX/v5.35/packs/Microchip/PIC18Fxxxx_DFP/1.2.26/xc8\pic\include\proc\pic18f4620.h"
...
# 19 "MCAL_Layer/GPIO/../std_types.h"
...
# 22
Std_ReturnType gpio_pin_direction_intialize(const pin_config_t* _pin_config){
Std_ReturnType LocalReturn=(Std_ReturnType)0x00;
if(_pin_config==(0) || (_pin_config->port)>5 || (_pin_config->pin)>8){
LocalReturn=(Std_ReturnType)0x00;
}else{
switch(_pin_config->directin){
case INPUT:
*tris_register[_pin_config->port]|=((uint8)1<<_pin_config->pin);
LocalReturn=(Std_ReturnType)0x01;
break;
case OUTPUT:
*tris_register[_pin_config->port]&=(~((uint8)1<<_pin_config->pin));
LocalReturn=(Std_ReturnType)0x01;
...
Std_ReturnType gpio_pin_get_direction_status(const pin_config_t* _pin_config,direction_t* direction_status){
Std_ReturnType LocalReturn=(Std_ReturnType)0x00;
if(_pin_config==(0) || (_pin_config->port)>5 || (_pin_config->pin)>8 || direction_status==(0)){
LocalReturn=(Std_ReturnType)0x00;
}else{
...
Std_ReturnType gpio_pin_write_logic(const pin_config_t* _pin_config,logic_t logic){
Std_ReturnType LocalReturn=(Std_ReturnType)0x00;
if(_pin_config==(0) || (_pin_config->port)>5 || (_pin_config->pin)>8 || (_pin_config->directin==INPUT)){
LocalReturn=(Std_ReturnType)0x00;
}else{
switch(logic){
case HIGH:
...
Std_ReturnType gpio_pin_read_logic(const pin_config_t* _pin_config,logic_t* logic){
Std_ReturnType LocalReturn=(Std_ReturnType)0x00;
if(_pin_config==(0) || logic==(0) || (_pin_config->port)>5 || (_pin_config->pin)>8){
LocalReturn=(Std_ReturnType)0x00;
}else{
...
Std_ReturnType gpio_port_get_direction_status(port_index_t port,uint8* directionPortStatus){
Std_ReturnType LocalReturn=(Std_ReturnType)0x00;
if(port>5 || directionPortStatus==(0)){
LocalReturn=(Std_ReturnType)0x00;
}else{
